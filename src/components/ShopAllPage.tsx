  ...
  return (
    <div className="space-y-8">
      ...
      {products.length === 0 ? (
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-1.5 sm:gap-4 md:gap-6">
            ...
            >
              ...
              >
                ...
                <div className="absolute top-1 left-1 sm:top-3 sm:left-3 z-10">
                  <span className={`px-1 py-0.5 sm:px-2.5 sm:py-1 text-[8px] sm:text-[10px] font-mono tracking-wider font-semibold rounded uppercase border ${getBadgeTagStyles(product.tag)}`}>
                    {product.tag}
                  </span>
                </div>
                {/* Save item Button */}
                ...
                >
                  <Heart className={`w-3 h-3 sm:w-4 h-4 ${wishlist.includes(product.id) ? 'fill-red-500 text-red-500' : ''}`} />
                </button>
              </div>
              ...
              <div className="p-1.5 sm:p-4 lg:p-5 flex flex-col flex-1 space-y-2 sm:space-y-4">
                <div className="space-y-0.5 sm:space-y-1">
                  ...
                  <div className="flex flex-wrap items-center gap-0.5 sm:gap-1.5">
                    <span className="text-[8px] sm:text-[10px] font-mono tracking-wider bg-neutral-100 text-neutral-600 border border-neutral-200 px-1 py-0.2 sm:px-1.5 sm:py-0.5 rounded uppercase font-medium truncate max-w-[50px] sm:max-w-none">
                      {product.category}
                    </span>
                    {product.artist && (
                      <span className="text-[8px] sm:text-[10px] font-mono tracking-wider bg-blue-50 text-blue-700 border border-blue-250 px-1 py-0.2 sm:px-1.5 sm:py-0.5 rounded uppercase font-semibold truncate max-w-[50px] sm:max-w-none">
                        {product.artist}
                      </span>
                    )}
                  </div>
